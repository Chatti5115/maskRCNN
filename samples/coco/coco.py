...
DEFAULT_LOGS_DIR = os.path.join("../../../Downloads/MaskRCNN-2/", "logs")
...
class CocoConfig(Config):
    ...
    NUM_CLASSES = 1 + 6  # case2는 6개의 객체를 가짐
    
    # Maximum number of ground truth instances to use in one image
    # 여러겹 나오는 박스 모두 포함하는듯, 100이하로 낮추지 말기
...
#                     )
        ...
        # Validation dataset
        dataset_val = CocoDataset()
        val_type = "test"#"val" if args.year in '2017' else "minival"
